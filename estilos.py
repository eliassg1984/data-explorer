...
def get_css():
    ...
    :root {
        ...
        --danger-text: #991b1b;
        --border-lavender: #d4cdf7;
        --icon-muted: #85858f;
        --focus-lavender: #b9aff2;
        --line-soft: #f1f1f4;
        --exit-hover: #52525c;
        --scroll-thumb: #d6d6dd;
        ...
        /* GEOMETRIA DE LA CABECERA FIJA — AJUSTE DE INVENTARIO */
        --cab-altura: 104px;
        --cab-nivel1-top: 30px;
        --cab-nivel2-top: 40px;
        --cab-offset-contenido: 112px;

        /* BARRA INFERIOR DE NAVEGACION EN MOVIL */
        --nav-movil-alto: 60px;
    }
    ...
    /* ============ EXCEPCION: PANEL DE RENDIMIENTO DEL NAVEGADOR ============ */
    ...
    /* ============ BOTON PARA EXPANDIR EL SIDEBAR ============ */
    ...
    h1 { color: var(--text-primary) !important; font-size: 1.6rem !important; font-weight: 700 !important; }
    h2, h3 { color: var(--text-primary) !important; font-weight: 600 !important; }
    h4 { color: var(--accent) !important; font-weight: 600 !important; }
    label {
    ...
    .stMultiSelect > div > div:hover { border-color: var(--accent) !important; }
    ...
    @media screen and (max-width: 768px) {
        ...
        [data-testid="stMain"] { padding: 0.5rem 0.5rem !important; margin-top: 0 !important; }
        .block-container,
        .stMainBlockContainer {
        ...
        [data-testid="stSidebarUserContent"] { padding: 12px 8px !important; }
        ...
        h1 { font-size: 1.3rem !important; margin-top: 0 !important; padding-top: 0.5rem !important; }
    ...
    /* =================================================================== */
    /* SELECTOR DE VISTA — tabs subrayados (legacy st.radio en vistatabs_)  */
    /* =================================================================== */
    ...
    [class*="st-key-vistatabs_"] [role="radiogroup"] label > div:first-child { display: none !important; }
    ...
    /* =================================================================== */
    /* BOTON FILTROS (popover) — grande y con contorno indigo               */
    /* =================================================================== */
    ...
    /* Contenedor de las pestanas del nivel 2 (fijado sobre la banda blanca) */
    ...
    /* ================================================================== */
    /* CHIPS DE FILTRO EN LA FRANJA BLANCA — Area / Familia / Ajuste / AjV */
    /* ================================================================== */
    ...
    /* =================================================================== */
    .st-key-fecha_ajuste_pill { margin-top: -10px !important; }
    ...
    /* =================================================================== */
    /* POSICION DEL TOAST (st.toast) — cerca del boton de refresco del rail */
    /* =================================================================== */
    ...
    @media screen and (max-width: 768px) {
        ...
        .st-key-fila_ajuste_top { margin-bottom: 12px !important; }
        .st-key-fila_ajuste_top [data-testid="stHorizontalBlock"] {
            gap: 4px !important;
    ...
    /* --- Movil: mantiene Opcion C pero mas compacto para tocar --- */
    @media screen and (max-width: 768px) {
        .st-key-ajuste_tabs_top [data-testid="stPills"] {
            gap: 4px !important;
        }
