...
# Se re-importa aquí para que el resto de dashboards de este módulo y los
# consumidores externos (app.py, tests) sigan viéndola como graficos.X
...
# Re-export para que renderizar_graficos_reporte() y consumidores externos lo sigan viendo aquí.
...
# ===========================================================================
# HELPERS LEGACY DE CARDS (solo Inventario Valorizado v1 · NO TOCAR)
#
# El patrón ACTUAL de cards (`_card`) y `_slug` viven en graficos/base.py.
# Aquí solo quedan _chart_card / _chart_card_close: abren y cierran un div por
# markdown y NO envuelven de verdad a los elementos. No usar en código nuevo.
# ===========================================================================
