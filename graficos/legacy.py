"""
graficos.legacy — dashboard LEGACY de Inventario Valorizado (v1).

Reemplazado por graficos.inventario en la ruta de la vista Gráficos.
Se conserva intacto como respaldo del layout viejo — NO TOCAR.
"""
...
from tema import BLANCO, ESCALA_CONTINUA, ESCALA_SEMAFORO, SERIE_PRINCIPAL
from utils import buscar_columna
from graficos.base import PALETA_CALLAI
