...
def get_css():
    ...
    [class*="st-key-vistatabs_"] [role="radiogroup"] label p {
        ...
        color: var(--text-secondary) !important;
        margin: 0 !important;
        text-transform: none !important;   /* <--- CAMBIO 2a */
        letter-spacing: 0 !important;      /* <--- CAMBIO 2a */
    }
    ...
    .st-key-fila_ajuste_top {
        margin-top: -6px !important;               /* <--- CAMBIO 1 */
    }
    ...
    .st-key-fch_ajuste_inline .stDateInput > div > div {
        ...
        box-shadow: none !important;
        padding: 0 10px !important;                    /* <--- CAMBIO 3a */
        min-height: 34px !important;                   /* <--- CAMBIO 3a */
        height: 34px !important;                       /* <--- CAMBIO 3a */
        width: fit-content !important;                 /* <--- CAMBIO 3a */
        margin: 0 auto !important;                     /* <--- CAMBIO 3a (centra) */
    ...
    .st-key-fch_ajuste_inline .stDateInput input {
        ...
        font-weight: 500 !important;
        font-size: 12.5px !important;                 /* <--- CAMBIO 3b */
        background: transparent !important;
        text-align: center !important;                 /* <--- CAMBIO 3b */
        padding: 0 !important;                         /* <--- CAMBIO 3b */
        width: 155px !important;                       /* <--- CAMBIO 3b */
    }
