...
paquete. La API publica no cambio: from inyecciones import inject_*.
    ...
    hover_kpis.py   una pila de KPIs sigue al cursor, sin rerun: sobre el
                    grafico Plotly de su tarjeta (inject_hover_kpis) o sobre
                    las COLUMNAS de su AgGrid (inject_hover_kpis_grid)
