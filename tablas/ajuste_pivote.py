...
def renderizar_aggrid_pivote_ajuste(df_wide, periodos, col_familia,
    ...
    gb.configure_grid_options(
        ...
        #
        # (Entre el 2026-09-23 y el mismo día a la noche acá hubo un vigilante
        # que traía a la vista la columna del periodo marcado en la serie de
        # Evolución, vía `context.foco`. Se fue cuando la tabla pasó a ser su
        # propia vista, regla #504. La lección que dejó está en la #501:
        # `onFirstDataRendered` no vuelve a disparar si la grilla conserva su
        # key y sólo le cambian las opciones.)
        onGridReady=JsCode(
