...
renderizar_aggrid_compras es la que se usa (la consume el drill de Compras).
renderizar_tabla_compras es la version legacy basada en st.data_editor: no la
importa nadie, se conserva a la espera de decision sobre si eliminarla.
"""
