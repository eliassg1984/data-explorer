...
324. **El `pause` no era la causa: la tarea corría python DIRECTO, y lo que
     ...
     ignored, instance already running") de protagonista:
         ...
         02/09 03:00  329  <- la matan a los 3 días (ExecutionTimeLimit)

         03/09 03:00  100  INICIADA

         04..06/09    322  ignorada x3

         06/09 03:00  329  <- la matan a los 3 días



     El evento a buscar es el **329**, que lo dice con todas las letras

     ("cerró la instancia porque superó el tiempo asignado para

     ejecutarse"); el 102 que sale junto engaña, porque se llama

     "finalizó correctamente". El código devuelto de la acción es

     `2147942659` (0x80070103): el script NO retornó por su cuenta.
